        ...
        return this.messagesProvider.invalidateConversations().then(function () {
            return _this.fetchData().finally(function () {
                if (refresher) {
                    ...
                    _this.messagesProvider.refreshContactRequestsCount(_this.siteId);
                    refresher.complete();
                }
            });
        });
...
function View_AddonMessagesGroupConversationsPage_2(_l) { return core["_57" /* ɵvid */](0, [(_l()(), core["_31" /* ɵeld */](0, 0, null, null, 14, "ion-item-divider", [["class", "core-expandable item item-divider"], ["color", "light"], ["text-wrap", ""]], null, [[null, "click"]], function (_v, en, $event) { var ad = true; var _co = _v.component; if (("click" === en)) {
