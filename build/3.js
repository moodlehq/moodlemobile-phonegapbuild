...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__section__ = __webpack_require__(1216);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_components_module__ = __webpack_require__(1195);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__providers_utils_text__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__providers_course__ = __webpack_require__(37);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__providers_helper__ = __webpack_require__(639);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__providers_format_delegate__ = __webpack_require__(86);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__providers_module_prefetch_delegate__ = __webpack_require__(250);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__providers_options_delegate__ = __webpack_require__(154);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__courses_providers_courses__ = __webpack_require__(57);
// (C) Copyright 2015 Martin Dougiamas
//
// Licensed under the Apache License, Version 2.0 (the "License");
// you may not use this file except in compliance with the License.
 ...
 */
var CoreCourseSectionPage = /** @class */ (function () {
    function CoreCourseSectionPage(navParams, courseProvider, domUtils, courseFormatDelegate, courseOptionsDelegate, translate, courseHelper, eventsProvider, textUtils, coursesProvider, sitesProvider, navCtrl, prefetchDelegate) {
        var _this = this;
        ...
        this.handlerData = {}; // Data to send to the handlers components.
    ...
    CoreCourseSectionPage.prototype.ionViewDidLoad = function () {
        var _this = this;
        var module = this.navParams.get('module');
        if (module) {
    ...
    CoreCourseSectionPage.prototype.loadData = function (refresh) {
        ...
        return this.coursesProvider.getUserCourse(this.course.id).catch(function () {
            ...
            promises.push(promise.then(function (completionStatus) {
                ...
                promises.push(_this.courseProvider.getSections(_this.course.id, false, true).then(function (sections) {
            ...
            promises.push(_this.courseOptionsDelegate.getHandlersToDisplay(_this.course, refresh, false).then(function (handlers) {
    ...
    CoreCourseSectionPage.prototype.prefetchCourse = function () {
        ...
        this.courseHelper.confirmAndPrefetchCourse(this.prefetchCourseData, this.course, this.sections, this.courseHandlers)
            ...
            if (downloaded && _this.downloadEnabled) {
                // Recalculate the status.
    ...
    CoreCourseSectionPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavParams */], __WEBPACK_IMPORTED_MODULE_7__providers_course__["a" /* CoreCourseProvider */], __WEBPACK_IMPORTED_MODULE_5__providers_utils_dom__["a" /* CoreDomUtilsProvider */],
            ...
            __WEBPACK_IMPORTED_MODULE_6__providers_utils_text__["a" /* CoreTextUtilsProvider */], __WEBPACK_IMPORTED_MODULE_12__courses_providers_courses__["a" /* CoreCoursesProvider */],
            __WEBPACK_IMPORTED_MODULE_4__providers_sites__["a" /* CoreSitesProvider */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */],
