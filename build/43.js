...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__discussion__ = __webpack_require__(1307);
    ...
    AddonMessagesDiscussionPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            ...
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_3__discussion__["a" /* AddonMessagesDiscussionPage */]),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__providers_sync__ = __webpack_require__(277);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__core_user_providers_user__ = __webpack_require__(73);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__providers_utils_dom__ = __webpack_require__(11);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__providers_app__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__classes_animations__ = __webpack_require__(701);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13_ts_md5_dist_md5__ = __webpack_require__(76);
...
var AddonMessagesDiscussionPage = /** @class */ (function () {
    ...
    AddonMessagesDiscussionPage.prototype.addMessage = function (message, keep) {
        ...
        message.hash = __WEBPACK_IMPORTED_MODULE_13_ts_md5_dist_md5__["Md5"].hashStr(message.smallmessage) + '#' + message.timecreated + '#' + message.useridfrom;
    ...
    AddonMessagesDiscussionPage.prototype.deleteMessage = function (message, index) {
        ...
        this.domUtils.showConfirm(this.translate.instant(langKey)).then(function () {
            ...
            _this.messagesProvider.deleteMessage(message).then(function () {
    ...
    AddonMessagesDiscussionPage.prototype.resizeContent = function () {
        ...
        setTimeout(function () {
            ...
            if (_this.content && _this.content.contentHeight != _this.oldContentHeight) {
                if (!top) {
