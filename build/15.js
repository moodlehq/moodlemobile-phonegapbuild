...
var entry_AddonModDataEntryPage = /** @class */ (function () {
    function AddonModDataEntryPage(params, utils, groupsProvider, domUtils, fieldsDelegate, courseProvider, dataProvider, dataOffline, dataHelper, sitesProvider, navCtrl, eventsProvider, cdr) {
        this.utils = utils;
    ...
    AddonModDataEntryPage.prototype.fetchEntryData = function (refresh, isPtr) {
        ...
        return this.dataProvider.getDatabase(this.courseId, this.module.id).then(function (data) {
            ...
            _this.entryHtml = _this.dataHelper.displayShowFields(templte, fieldsArray, _this.entry, _this.offset, 'show', actions);
...
var rating = __webpack_require__(172);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__providers_rating__ = __webpack_require__(172);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__providers_offline__ = __webpack_require__(168);
/**
 * @fileoverview This file was generated by the Angular template compiler. Do not edit.
 *
 * @suppress {suspiciousCode,uselessCode,missingProperties,missingOverride,checkTypes}
